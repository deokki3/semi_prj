				...
				<div id="resultInner">
					...
					<c:forEach var="vo" items="${requestScope.mslist }">					
						<div id="resultSection">
							<div id="content">
								<div id="innerimg">
								<a href="${cp }/movieDetail?num_pk=${vo.num_pk}&id_pk=${sessionScope.id_pk }">	
					...
					<c:forEach var="vo" items="${requestScope.aslist }">
						...
						<div id="content">
						<div id="innerimg">
						<a href="${cp }/actorDetailList?num_pk=${vo.num_pk}&id_pk=${sessionScope.id_pk}">
					...
					<c:forEach var="vo" items="${requestScope.dslist }">
						...
						<div id="content">
						<div id="innerimg">
						<a href="${cp }/directorDetailList?num_pk=${vo.num_pk}&id_pk=${sessionScope.id_pk}">
